...
const unassigned = mockComplaints.filter(c => !c.assigned_to);
          ...
          <Table>
            ...
            <TableBody>
              {unassigned.length > 0 ? unassigned.map(c => (
                ...
                <TableRow>
                  <TableCell colSpan={11} className="text-center text-muted-foreground py-8">All complaints are assigned</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
