...
const UnassignedComplaintsPage = () => {
  const [complaints, setComplaints] = useState(initialComplaints.filter(c => !c.assigned_to));
            ...
            <Table>
              ...
              <TableBody>
                {complaints.length > 0 ? complaints.map(c => (
                  ...
                  <TableRow>
                    <TableCell colSpan={12} className="text-center text-muted-foreground py-8">All complaints are assigned</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
